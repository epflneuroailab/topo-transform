...
def compute_timeseries(
    ...
    for ckpt_path in ckpt_paths:
        ...
        _imagenet_pre, imagenet_post = task_performance(ckpt_name, "imagenet")
        _ssv2_pre, ssv2_post = task_performance(ckpt_name, "ssv2")
    ...
    return epochs, neural_scores, task_scores, topo_loss_scores


def plot_timeseries(epochs, neural_scores, task_scores, topo_loss_scores, save_path):
...
def main():
    ...
    epochs, neural_scores, task_scores, topo_loss_scores = compute_timeseries(
        ckpt_paths,
    ...
    plot_timeseries(epochs, neural_scores, task_scores, topo_loss_scores, Path(args.out))
